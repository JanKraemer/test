		...
		RestApi.create( )
			   ...
			   .transitions()
					.fromState( "StartState" )
			   			.asHeaderLink().toState( "GetAllUser" )
			   			.usingRelationType( "getAllUser" )
					.fromState( "StartState")
						.asHeaderLink().toState("GetSessionById")
						.usingRelationType("getSessinById")
					.fromState( "StartState" )
						.asHeaderLink().toState( "CreateSession" )
						.usingRelationType( "createSession" )
					.fromState( "StartState")
						.asHeaderLink().toState("DeleteSession")
						.usingRelationType("deleteSession")
			   		.fromState( "GetAllUser" )
						.asHeaderLink().toState("CreateUser")
						.usingRelationType("createUser")
					.fromState("GetAllUser")
						.asContentLink().toState( "GetUserById")
			   		.fromState( "GetUserById" )
						.asHeaderLink().toState( "DeleteUser" )
						.usingRelationType("deleteUser")
			   		.fromState( "GetUserById" )
			   			.asHeaderLink().toState( "UpdateUser" )
						.usingRelationType( "updateUser" )
