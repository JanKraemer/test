...
/* ***************************************************************************** 
  ...
  de.fhws.applab.gemara.dalston.generator.api.states.primary.delete.singleresource.DeletePrimaryResourceStateGenerator
...
import de.fhws.applab.gemara.norbury.core.api.states.delete.AbstractDeleteState;
import de.fhws.ifactory.api.api.states.DeleteSessionState;
...
public class DeleteSessionState extends AbstractDeleteState<Session>
{
public DeleteSessionState(){ super(); }
...
// ###(loadModelFromDatabase) You can edit above this line ### 
 ...
 @Override protected NoContentDatabaseResult deleteModelInDatabase( )
{

// ###(deleteModelFromDatabase) You can edit below this line ### 
return null;

// ###(deleteModelFromDatabase) You can edit above this line ### 
}
}
