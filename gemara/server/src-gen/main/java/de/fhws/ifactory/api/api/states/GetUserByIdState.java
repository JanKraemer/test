...
import de.fhws.ifactory.api.api.states.GetUserByIdState;
...
public class GetUserByIdState extends AbstractGetState<User>
{
public GetUserByIdState(){}
...
addLink( "/mensa/api/users/{id}", "deleteUser", "application/vnd.fhws-user.default+json", this.requestedId );
addLink( "/mensa/api/users/{id}", "updateUser", "application/vnd.fhws-user.default+json", this.requestedId );
}
