...
import de.fhws.ifactory.api.api.states.CreateUserState;
...
public class CreateUserState extends AbstractPostState<User,UserViewModel>
{
public CreateUserState(){ super(); }
...
// ###(createModelInDatabase) You can edit above this line ### 
 ...
 @Override protected User createDatabaseModel( ){	return new User( );}
}
